...
const String contactInfo401 = 'Contacto de Bienestar Oficina Principal: [Número Real Aquí] (Ajusta el número real aquí)';

// Lista de Rooms específicas del edificio 401
final List<Room> rooms401 = [
  // --- SERVICIOS GENERALES / PISO 1 (Se pueden agrupar en 'General' o su piso real) ---
  Room(
    id: '401-Aud-JuanBautista',
    number: 'Aud. Juan Bautista',
    name: 'Auditorio Juan Bautista Gómez Rodríguez',
    floor: 'Piso 1', // O 'General' si lo quieres en la pestaña principal
  ),
  Room(
    id: '401-Aud-CarlosBarberi',
    number: 'Aud. Carlos Barberi',
    name: 'Auditorio Carlos Alberto Barberi Perdomo',
    floor: 'Piso 1', // O 'General'
  ),
  Room(
    id: '401-CT101',
  ...
  Room(
    id: '401-JuegosCargadores',
    number: 'Juegos y Cargadores',
  ...
  Room(
    id: '401-BanoMujeresDer',
    number: 'Baño Mujeres Der.',
  ...
  // --- PISO 3 (Anteriormente 'General' en tu data, pero el texto dice 'Tercer piso') ---
  Room(
