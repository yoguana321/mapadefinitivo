...
final List<Room> rooms401 = [
  ...
  Room(
    ...
    isServiceRoom: false, // Explicitly set to false
  ),
  Room(
  ...
  Room(
    ...
    floor: 'Piso 2',
    category: 'Oficinas Administrativas', // Added category - often functions administratively
    isServiceRoom: false,
  ),
  Room(
  ...
  Room(
    ...
    floor: 'Piso 3',
    category: 'Salones Especiales', // Added category - special use for wellbeing
    isServiceRoom: true,
  ),
  Room(
    id: '401-CT301',
