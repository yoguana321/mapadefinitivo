...
const String contactInfo407 = 'Contacto: Secretaría de Posgrados de Materiales - Facultad de Ingeniería.';
...
final List<Room> rooms407 = [
  ...
  Room(
    ...
    floor: 'Piso 1',
    isServiceRoom: false,
    category: 'Laboratorios', // Mantenido, mapea bien
  ),
  Room(
  ...
  Room(
    ...
    floor: 'Piso 1',
    isServiceRoom: false,
    category: 'Aulas Especializadas', // 'Sala Especializada' es un poco genérica, 'Aulas Especializadas' con el ícono de laptop puede aplicar bien si es un aula con equipos o para usos específicos.
  ),
  Room(
    id: '407-1-salon-101',
    number: 'Salón 101',
    ...
    floor: 'Piso 1',
    isServiceRoom: false,
    category: 'Aulas', // Mantenido, mapea bien
  ),
  Room(
    id: '407-1-salon-102',
    number: 'Salón 102',
  ...
  Room(
    ...
    number: 'Salón 103',
    name: 'Oficina / Salón 103', // Es una oficina de profesores con número de salón. Se categoriza como oficina.
    floor: 'Piso 1',
    professors: [
  ...
  Room(
    ...
    floor: 'Piso 2',
    isServiceRoom: false,
    category: 'Auditorios', // Cambiado de 'Auditorio' a 'Auditorios' para unificar
  ),
  Room(
    id: '407-2-salon-201',
    number: 'Salón 201',
  ...
  Room(
    ...
    floor: 'Piso 2',
    isServiceRoom: false,
    category: 'Secretaría', // Mantenido, mapea bien
  ),
  Room(
    id: '407-2-metalurgia-coordinacion-204',
    number: 'Coordinación 204',
    name: 'Coordinación de Metalurgia (Salón 204)',
    floor: 'Piso 2',
    isServiceRoom: false,
    category: 'Oficinas Académicas', // 'Coordinación' es una oficina con fin académico.
  ),
  Room(
