...
final List<Room> rooms453 = [
  ...
  Room(id: '453-bebederos', number: 'General', name: 'Bebederos', floor: 'General', isServiceRoom: true, category: 'Servicios'),
  Room(id: '453-puntos-carga', number: 'General', name: 'Puntos de Carga', floor: 'General', isServiceRoom: true, category: 'Servicios'),
  Room(id: '453-banos-dcha-mujer', number: 'Baños', name: 'Baños Mujeres (Derecha entrada)', floor: 'Piso 1', isServiceRoom: true, category: 'Servicios'), // Assuming general entrance means Piso 1
  Room(id: '453-banos-fondo-hombres', number: 'Baños', name: 'Baños Hombres (Al fondo de entrada)', floor: 'Piso 1', isServiceRoom: true, category: 'Servicios'), // Assuming general entrance means Piso 1

  // Auditorios
  Room(id: '453-auditorio-a', number: 'Auditorio A', name: 'Auditorio A', floor: 'Piso 1', isServiceRoom: false, category: 'Auditorios'),
  Room(id: '453-auditorio-b', number: 'Auditorio B', name: 'Auditorio B', floor: 'Piso 1', isServiceRoom: false, category: 'Auditorios'),
  Room(id: '453-auditorio-c-antonio-maria-gomez-m', number: 'Auditorio C', name: 'Auditorio C Antonio María Gómez M', floor: 'Piso 1', isServiceRoom: false, category: 'Auditorios'),

  // --- PISO 1 ---
  Room(id: '453-1-aula-100', number: '100', name: 'Aula 100', floor: 'Piso 1', isServiceRoom: false, category: 'Aulas'),
  Room(id: '453-1-oficina-101', number: '101', name: 'Dirección Departamento de Sistemas e Industrial', floor: 'Piso 1', isServiceRoom: false, category: 'Oficinas Administrativas'),
  ...
  Room(id: '453-1-aula-103', number: '103', name: 'Aula 103', floor: 'Piso 1', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-1-aula-105', number: '105', name: 'Aula 105', floor: 'Piso 1', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-1-aula-107', number: '107', name: 'Aula 107', floor: 'Piso 1', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-1-aula-109', number: '109', name: 'Aula 109', floor: 'Piso 1', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-1-aula-111', number: '111', name: 'Aula 111', floor: 'Piso 1', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-1-aula-113', number: '113', name: 'Aula 113', floor: 'Piso 1', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-1-aula-115', number: '115', name: 'Aula 115', floor: 'Piso 1', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-1-unidad-informatica-119', number: '119', name: 'Unidad de Informática 119', floor: 'Piso 1', isServiceRoom: false, category: 'Sala de Cómputo'),
  ...
  Room(id: '453-2-oficina-201', number: '201', name: 'Dirección de Departamento Ingeniería Civil y Agrícola', floor: 'Piso 2', isServiceRoom: false, category: 'Oficinas Administrativas'),
  ...
  Room(id: '453-2-lab-203', number: '203', name: 'Laboratorio de Bases de Datos y Sistemas de Información', floor: 'Piso 2', isServiceRoom: false, category: 'Laboratorios'),
  ...
  Room(id: '453-2-aula-205', number: '205', name: 'Aula 205', floor: 'Piso 2', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-2-aula-207', number: '207', name: 'Aula 207 (Departamento de Ingeniería de Sistemas e Industrial - Investigación en Sistemas Inteligentes. Incluye Laboratorio Mindlab, Laboratorio LISI, Grupo de Investigación en Gestión y Organizaciones (GRIEGO), Grupo de Investigación en Geomántica (ANGeoSc), Grupo de Investigación en Redes de Telecomunicaciones Dinámicas & Lenguajes de Programación Distribuidos (TLON), Grupo de Investigación en Algoritmos y Combinatoria (ALGOS), Laboratorio UnSecureLab: Investigación en Ciberseguridad)', floor: 'Piso 2', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-2-oficina-209', number: '209', name: 'Dirección Área Curricular de Ingeniería Sistemas e Industrial', floor: 'Piso 2', isServiceRoom: false, category: 'Oficinas Administrativas'),
  ...
  Room(id: '453-2-grupo-211', number: '211', name: 'MDLYGE Grupo de Investigación de Mecanismo de Desarrollo Limpio y Gestión Energética', floor: 'Piso 2', isServiceRoom: false, category: 'Centros de Investigación'),
  ...
  Room(id: '453-2-lab-213', number: '213', name: 'Laboratorio de Ingeniería Industrial', floor: 'Piso 2', isServiceRoom: false, category: 'Laboratorios'),
  Room(id: '453-2-aula-214', number: '214', name: 'Aula 214', floor: 'Piso 2', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-2-sala-posgrados-sistemas-221', number: '221', name: 'Sala de Postgrados de Sistemas', floor: 'Piso 2', isServiceRoom: false, category: 'Salas de Estudio'),
  Room(id: '453-2-sala-descanso', number: 'General', name: 'Sala de Descanso (con puertos de carga y máquina expendedora)', floor: 'Piso 2', isServiceRoom: true, category: 'Servicios'),
  Room(id: '453-2-oficina-222', number: '222', name: 'Dirección Ingeniería Eléctrica y Electrónica - Coordinación Curricular Eléctrica', floor: 'Piso 2', isServiceRoom: false, category: 'Oficinas Administrativas'),
  Room(id: '453-2-lab-224', number: '224', name: 'Laboratorio de Ingeniería de Software y Arquitectura de Hardware y Software', floor: 'Piso 2', isServiceRoom: false, category: 'Laboratorios'),
  Room(id: '453-2-sala-profesores', number: 'Sala Profesores', name: 'Sala de Profesores (Piso 2)', floor: 'Piso 2', isServiceRoom: false, category: 'Salas de Profesores'),
  Room(id: '453-2-oficina-226', number: '226', name: 'Dirección de Postgrados, Registro y Programación Académica', floor: 'Piso 2', isServiceRoom: false, category: 'Oficinas Administrativas'),
  Room(id: '453-2-oficina-228', number: '228', name: 'Oficina de Estudiantes', floor: 'Piso 2', isServiceRoom: false, category: 'Oficinas Administrativas'),
  Room(id: '453-2-oficina-230', number: '230', name: 'Administración del Edificio', floor: 'Piso 2', isServiceRoom: false, category: 'Oficinas Administrativas'),
  ...
  Room(id: '453-3-oficina-301', number: '301', name: 'Dirección de Departamento Ingeniería Química y Ambiental', floor: 'Piso 3', isServiceRoom: false, category: 'Oficinas Administrativas'),
  ...
  Room(id: '453-3-aula-303', number: '303', name: 'Aula 303', floor: 'Piso 3', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-3-aula-307', number: '307', name: 'Aula 307', floor: 'Piso 3', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-3-aula-309', number: '309', name: 'Aula 309', floor: 'Piso 3', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-3-aula-311', number: '311', name: 'Aula 311', floor: 'Piso 3', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-3-aula-313', number: '313', name: 'Aula 313', floor: 'Piso 3', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-3-aula-315', number: '315', name: 'Aula 315', floor: 'Piso 3', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-3-aula-317', number: '317', name: 'Aula 317', floor: 'Piso 3', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-3-aula-319', number: '319', name: 'Aula 319', floor: 'Piso 3', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-4-oficina-401', number: '401', name: 'Dirección de Departamento Ingeniería Mecánica y Mecatrónica', floor: 'Piso 4', isServiceRoom: false, category: 'Oficinas Administrativas'),
  ...
  Room(id: '453-4-aula-403', number: '403', name: 'Aula 403', floor: 'Piso 4', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-4-aula-405', number: '405', name: 'Aula 405', floor: 'Piso 4', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-4-aula-407', number: '407', name: 'Aula 407', floor: 'Piso 4', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-4-aula-409', number: '409', name: 'Aula 409', floor: 'Piso 4', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-4-aula-411', number: '411', name: 'Aula 411', floor: 'Piso 4', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-4-aula-413', number: '413', name: 'Aula 413', floor: 'Piso 4', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-4-aula-415', number: '415', name: 'Aula 415', floor: 'Piso 4', isServiceRoom: false, category: 'Aulas'),
  ...
  Room(id: '453-4-aula-417', number: '417', name: 'Aula 417', floor: 'Piso 4', isServiceRoom: false, category: 'Aulas'),
